 ...
 * THREE.ClampToEdgeWrapping, THREE.MirroredRepeatWrapping
 *                  normalizeRGB: RGBs need to be normalized to 0-1 from 0-255
 *                                Default: false, assumed to be already
 * normalized
 *                  ignoreZeroRGBs: Ignore values of RGBs (Ka,Kd,Ks) that are
 * all 0's
 *                                  Default: false
 * @constructor
 */
...
THREE.MTLLoader.MaterialCreator = function(baseUrl, options) {
  ...
  this.wrap = (this.options && this.options.wrap) ? this.options.wrap :
...
THREE.MTLLoader.MaterialCreator.prototype = {
    ...
    for (var prop in mat) {
      ...
      switch (prop.toLowerCase()) {
        ...
        case 'ns':
          ...
          // A high exponent results in a tight, concentrated highlight. Ns
  ...
  loadTexture: function(url, mapping, onLoad, onProgress, onError) {
    ...
    var manager = (this.manager !== undefined) ? this.manager :
